...
const SLUG = "licenciamento-ambiental";
const SERVICE_ID = "S5";
      ...
      <section className="py-10 lg:py-12 bg-background border-t border-[var(--color-border)]">
        <div className="container-site max-w-[760px]">
          <p className="text-[15px] text-foreground/70 leading-relaxed">
            O licenciamento ambiental abrange diferentes tipologias de estação. Veja os detalhes técnicos do sistema de tratamento de{" "}
            <Link
              href="/complexos/etdi"
