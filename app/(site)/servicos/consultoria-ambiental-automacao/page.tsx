...
const SLUG = "consultoria-ambiental-automacao";
const SERVICE_ID = "S7";
      ...
      <section className="py-10 lg:py-12 bg-background border-t border-[var(--color-border)]">
        <div className="container-site max-w-[760px]">
          <p className="text-[15px] text-foreground/70 leading-relaxed">
            Projetos de automação frequentemente integram obrigações regulatórias: saiba como funciona o{" "}
            <Link
              href="/servicos/licenciamento-ambiental"
              className="text-[var(--color-primary-700)] underline hover:text-[var(--color-primary-900)]"
            >
              licenciamento ambiental
            </Link>{" "}
            para empreendimentos com tratamento de efluentes.
          </p>
        </div>
      </section>
    </>
